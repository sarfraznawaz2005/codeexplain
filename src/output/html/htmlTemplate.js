...
<head>
    ...
    <div id="app" class="vh-100">
        ...
        ${config.mode === 'flowchart' || config.mode === 'architecture' || config.mode === 'arch' || config.mode === 'onboarding' ? '' : `
        ...
        <!-- Main Content -->
        <main style="${config.mode === 'flowchart' || config.mode === 'architecture' || config.mode === 'arch' || config.mode === 'onboarding' ? 'margin-left: 0px; width: 100%;' : 'margin-left: 280px; width: calc(100% - 280px);'} margin-top: 96px; padding: 2rem; transition: margin-left 0.3s ease; min-height: calc(100vh - 96px);">
